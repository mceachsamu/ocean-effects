Shader "Custom/water"
{
    ...
    SubShader {
        ...
        float4 getDistortion(float4 position) {
            ...
            // z -= 1.0 * abs(sin((wPosition.z/3.0 + wPosition.x/4.0) * _WaveFrequency/80.0 - _T * _WaveSpeed * 3.5)) * _WaveHeight*240.0;
            // z -= 1.0 * abs(sin((wPosition.z/3.0 + wPosition.x) * _WaveFrequency/60.0 + _T * _WaveSpeed * 1.5)) * _WaveHeight*240.0;
            // z -= 1.0 * (sin((wPosition.z/3.0 + wPosition.x/8.0) * _WaveFrequency/100.0 - _T * _WaveSpeed * 2.1)) * _WaveHeight*350.0;
            // z -= 1.0 * abs(sin((wPosition.z/8.0 + wPosition.x/2.0) * _WaveFrequency/150.0 + _T * _WaveSpeed * 4.2)) * _WaveHeight*400.0;
            // z -= 1.0 * abs(sin((wPosition.z/2.0 + wPosition.x/5.0) * _WaveFrequency/100.0 + _T * _WaveSpeed * 1.2)) * _WaveHeight*500.0;
